...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следущая",sPrevious:"Предыдущая"},sEmptyTable:"Нет данных для отображения",sInfo:"Отбражено с _START_ по _END_ из _TOTAL_ записей",
sInfoEmpty:"Отбражено с 0 по 0 из 0 записей",sInfoFiltered:"(отфильтровано _MAX_ записей)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Загрузка...",sProcessing:"Подождите...",sSearch:"Поиск:",sUrl:"",sZeroRecords:"Поиск не дал результатов"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
