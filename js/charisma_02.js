...
function docReady() {
    ...
    $('.dataTables_length').append('<a href="#modal3" class="btn btn-primary sotrd_add"><i class="glyphicon glyphicon-user icon-white"></i>&nbsp; &nbsp;Регистрация нового пользователя</a>');
